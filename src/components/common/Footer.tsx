...
import { FaApplePay, FaWhatsapp } from "react-icons/fa";
...
function FooterLink({ item }: FooterLinkProps) {
    return (
        <p className="group flex cursor-pointer text-left items-center justify-start gap-2 pr-8 py-2 text-[15px] hover:text-green-500">
            <span
...
export default function Footer() {
    ...
    const companyDetails = [
        {
            ...
            text: "17 W 29th St, New York, NY 10001",
        },
        {
    ...
    return (
        <footer className="mx-auto w-full cursor-default items-center justify-center bg-[#FAF9FF] dark:bg-[#18181b] shadow-xl md:px-0 dark:border-t dark:border-gamtech  z-50">
            <section className="flex flex-col   items-center justify-around shadow-xl md:flex-row md:gap-y-0 py-1">
                <Link href="/">
                    <Image
                        src="/images/logo.png"
                        alt="logo"
                ...
                <div className="flex gap-1">
                    ...
                    />
                    <SocialLink
                        href="https://www.facebook.com/helen.iwu.14/"
                            ...
                            <div className="flex gap-4 flex-wrap">
                                {
                                    icons_lists.map((item) => (
                                        <span className="hover:text-green-500">{item}</span>
                                    ))
                                }
                            </div>
                        </div>
