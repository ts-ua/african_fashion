...
const SubTypes = [
    {
        title: "Georges",
        subTypes: ["Plain George", "Medium Silk George", "Medium Silk Stoned George", "Heavy Beaded George", "French George", "Intorica George", "Stoned George", "Net George"]
    },
    {
        title: "Laces",
...
export { columns, users, statusOptions, types, SubTypes };
